...
# Permutation testing for Capstone work with RMI — REFINERIES ONLY
...
# file names specific to the refineries-only dfs
file_names <- paste0("adjacent_df_",buffer_sizes,"m_forpermutation_refs.tsv")
